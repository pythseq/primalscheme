...
from .models import CandidatePrimer, CandidatePrimerPair, Region, _primer, _primerPair, _candidatePrimer, _candidatePrimerPair, _region
    ...
    def _find_primers(self, region_num, left_primer_left_limit, left_primer_right_limit, is_last_region):
        ...
        while True:
            ...
            for cand_num in range(self.max_candidates):
                ...
                right = CandidatePrimer('RIGHT', right_name, right_seq, right_start)
